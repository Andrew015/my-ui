  ...
  return (
    <div>
      ...
      <div className="px-4 py-4">
        ...
        <section className="mt-3 rounded-2xl bg-gradient-to-br from-orange-50 to-yellow-50 p-4 ring-1 ring-orange-200/80">
          <p className="text-sm font-semibold text-emphasis">交换助手</p>
          <p className="mt-1 text-xs text-stone-600">
            上传你想置换的物品照片，智能推荐可交换结果
          </p>
          <button
            type="button"
            className="mt-3 w-full rounded-xl bg-brand py-2.5 text-sm font-medium text-brand-foreground transition hover:bg-brand-hover"
          >
            上传照片开始匹配
          </button>
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="rounded-full bg-white/90 px-2.5 py-1 text-[11px] text-emphasis ring-1 ring-orange-200/90">
              匹配示例：摄影器材
            </span>
            <span className="rounded-full bg-white/90 px-2.5 py-1 text-[11px] text-emphasis ring-1 ring-orange-200/90">
              匹配示例：桌面好物
        ...
        <section className="mt-4">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-base font-semibold text-emphasis">置换广场</h2>
            ...
            {filtered.map((item) => (
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div className="mt-2">
                    <span className="inline-flex rounded-full bg-orange-50 px-2 py-0.5 text-[11px] font-medium text-emphasis ring-1 ring-orange-200/80">
          ...
          {!filtered.length ? (
            <div className="mt-4 rounded-2xl border border-dashed border-orange-200/80 bg-white/70 py-8 text-center text-sm text-stone-500">
              暂无匹配置换结果，换个关键词试试
            </div>
          ) : null}
        </section>
